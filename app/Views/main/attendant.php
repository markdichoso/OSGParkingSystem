    ...
    <div class="w-full max-w-[1080px] mx-auto bg-white min-h-screen relative">
        ...
        <main class="pt-20 pb-8 px-5">
            ...
            <!-- <div
                ...
                class="hidden bg-white rounded-2xl shadow-md p-6 mb-6 fade-in">
                ...
                <div
                    ...
                    <img
                        id="employee-photo"
                        src="https://readdy.ai/api/search-image?query=professional%20business%20portrait%20of%20confident%20female%20employee%20in%20corporate%20attire%2C%20studio%20lighting%2C%20clean%20white%20background%2C%20high%20quality%20headshot%20photography%2C%20friendly%20smile%2C%20business%20casual%2C%20modern%20professional%20look&width=200&height=200&seq=emp001&orientation=squarish"
                        alt="Employee"
            ...
            <div id="transaction-type-section" class="hidden mb-6 fade-in">
            ...
            <div id="action-buttons-section" class="hidden space-y-3 mb-6">
                <button
                    id="confirm-button"
